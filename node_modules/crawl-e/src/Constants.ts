...
namespace Constants { 
  ...
  export const MAIN_DEBUG_PREFIX = 'crawl-e'
  
  /** default ouput directory path */
  export const OUTPUT_DIR = 'output'
  
  export const BOX_SELECTOR = ':box'
  ...
  export const TODAY_WORDS = ['avui', 'اليوم', 'Today', 'Бугун', 'Sot', 'Сегодня', 'Hoje', 'hoy', 'heute', 'vandaag', 'Idag', 'bugün', 'danas', 'আজ', 'Aujourd’hui', 'Днес', 'Hari', 'Сёння', 'leo', 'Oggi', 'Σήμερα', 'dnes', 'Täna,', 'tänään', 'आज', 'آج', 'Í', 'დღეს', 'ma', 'היום', 'امروز', 'í', '今日', 'Бүгүн', 'ថ្ងៃនេះ', '오늘', 'Бүгін', 'ມື້ນີ້ເວລາ', 'අද', 'இன்று', 'Šiandien', 'Haut', 'Šodien', 'azi', 'Денес', 'ယနေ.', 'Illum', 'މިއަދު', 'Vandag', 'Dziś', 'danes', 'Namuhla', 'วันนี้', 'Имрӯз', 'Сьогодні', 'Hôm']
  
  /** a list of "tomorrow" translated into many languages, useful for checking stings */
  export const TOMORROW_WORS = ['demà', 'غدًا', 'Tomorrow', 'Эртага', 'Nesër', 'Завтра', 'Amanhã', 'mañana', 'morgen', 'Imorgon', 'sabah', 'sutra', 'আগামীকাল', 'Demain', 'Утре', 'Esok', 'Заўтра', 'kesho', 'Domani', 'Αύριο', 'yarın', 'zítra', 'zajtra', 'Homme,', 'huomenna', 'कल', 'کل', 'Í', 'ხვალ', 'holnap', 'Besok', 'מחר', 'فردا', 'á', '明日', 'Эртең', 'ស្អែក', '내일', 'Ертең', 'ມື້ອື່ນເວລາ', 'හෙට', 'நாளை', 'Rytoj', 'Muer', 'Rīt', 'mâine', 'မနက်ဖြန်', 'Għada', 'މާދަމާ', 'Môre', 'भोलि', 'Jutro', 'jutri', 'Kusasa', 'พรุ่งนี้', 'Пагоҳ', 'Ngày']
  
  /** a list of "day after tomorrow" translated into many languages, useful for checking stings */
  export const DAY_AFTER_TOMORROW_WORS = ['Oormôre', 'পরশু দিন', 'pozítří', 'overmorgen', 'ülehomme', 'ylihuomenna', 'après-demain', 'übermorgen', 'μεθαύριο', 'aprè demen', 'दिन के बाद कल', 'nag kis', 'holnapután', 'daginn eftir morgundaginn', 'lusa', 'dopodomani', 'parīt', 'روز بعد از فردا', 'pojutrze', 'poimâine', 'послезавтра', 'прекосутра', 'prekosutra', 'pozajtra', 'pojutrišnjem',  'післязавтра']
  ...
  export const OS_NAME_BLACKLIST = [
    'Jigsaw',
    'portalmmm',
    'Kindle',
    'IEMobile',
  ...
  export const ORIGINAL_VERSION = 'original version'
  ...
  export const SUBTITLES_UNDETERMINED = 'undetermined'
}
